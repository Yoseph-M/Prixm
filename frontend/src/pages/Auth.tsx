...
export const Auth: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-screen bg-[#070709] flex font-sans m-0 p-0 overflow-x-hidden">
      <div className="flex w-full h-screen bg-[#070709]">

        {/* Left Panel: Aesthetic Dark Crimson flow background (Premium Brand Showcase) */}
        <div className="flex-[1.2] hidden md:flex md:max-w-[55%] relative border-r border-white/[0.03]">
          <div className="relative w-full h-full overflow-hidden flex items-end justify-start bg-[#070709]">
            <FlowFieldBackground
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-[#8b1a1a]/15 via-transparent to-black/55 pointer-events-none z-[2]"></div>
            <div className="absolute top-0 right-0 w-[120px] h-full bg-gradient-to-r from-transparent to-[#0b0b0d] pointer-events-none z-[3]"></div>

            {/* Branding Container */}
            <div className="absolute top-10 left-10 flex items-center gap-3 z-[15] bg-white/[0.04] backdrop-blur-md px-[18px] py-[10px] rounded-xl border border-white/10 shadow-[0_8px_24px_rgba(0,0,0,0.5)]">
              ...
              <div className="text-left">
                ...
                <p className="mt-1 text-[9px] font-semibold text-white/45 tracking-[0.18em] uppercase leading-none">Subscription Intelligence</p>
              </div>
            </div>

            {/* Bottom branding card */}
            <div className="absolute bottom-0 left-0 w-full z-10 bg-[#070709]/75 backdrop-blur-xl border-t border-white/8 px-10 py-10 flex items-start gap-5 shadow-[-20px_0_60px_rgba(0,0,0,0.6)]">
              <div className="w-11 h-11 bg-gradient-to-br from-[#8b1a1a] to-[#c13333] text-white rounded-lg flex items-center justify-center flex-shrink-0 shadow-[0_8px_24px_rgba(139,26,26,0.45)]">
              ...
              <div className="text-left">
                ...
                <p className="m-0 text-sm text-white/55 leading-relaxed font-normal max-w-[380px]">Prixm tracks every recurring payment, predicts renewals, and surfaces waste — so you stay in control of your spend.</p>
              </div>
            </div>
          </div>
        </div>

        {/* Right Panel: High-contrast, premium, polished dark form sheet */}
        <div className="flex-1 px-6 py-10 md:px-14 md:py-12 flex flex-col justify-center bg-[#0b0b0d] text-white w-full md:max-w-[45%] border-l border-white/[0.04] overflow-y-auto">
          <div className="max-w-[380px] w-full mx-auto text-left">
            ...
            <div className="flex md:hidden items-center gap-2.5 mb-8">
              ...
              <div className="text-left">
                ...
                <p className="mt-1 text-[8px] font-semibold text-white/40 tracking-[0.18em] uppercase leading-none">Subscription Intelligence</p>
              </div>
            </div>
            ...
            {mode === 'verify-pending' ? (
              ...
              <div className="text-center py-6 animate-[slide-in_0.4s_ease-out]">
                <div className="w-16 h-16 bg-[#8b1a1a]/12 border border-[#8b1a1a]/20 rounded-full flex items-center justify-center mx-auto mb-5 text-[#e87070] animate-pulse">
                ...
                <p className="text-sm text-white/50 mb-6 leading-relaxed">
                  We have sent a verification link to <span className="text-[#f87171] font-medium">{email}</span>. 
                  Please check your inbox and verify your email.
                </p>

                {resendSuccess && (
                  <div className="bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-xl px-4 py-3 text-sm mb-5 text-left leading-normal flex items-center gap-2.5" role="alert">
                ...
                <div className="flex flex-col gap-2.5">
                  ...
                  <button 
                    type="button" 
                    className="w-full h-11 bg-white/[0.04] border border-white/10 rounded-xl text-white/80 text-sm font-medium cursor-pointer flex items-center justify-center gap-2 transition duration-200 hover:bg-white/8 hover:text-white disabled:opacity-40 disabled:cursor-not-allowed focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#e87070]"
              ...
              <>
                ...
                <p className="text-sm text-white/50 m-0 mb-7 leading-relaxed">
                  {mode === 'signup'
                ...
                {authCtx.error && (
                  <div className="bg-red-500/10 text-red-400 border border-red-500/20 rounded-xl px-4 py-3 text-sm mb-5 text-left leading-normal flex items-center gap-2.5" role="alert">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="flex-shrink-0 text-red-450">
                ...
                <button 
                  type="button" 
                  className="w-full flex items-center justify-center gap-2.5 h-12 bg-white/[0.03] border border-white/[0.08] rounded-xl text-white/90 text-sm font-medium cursor-pointer transition duration-200 hover:bg-white/[0.06] hover:border-white/[0.15] hover:text-white hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(0,0,0,0.4)] active:translate-y-0 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#e87070]" 
                ...
                <div className="flex items-center text-center text-white/20 text-[11px] font-semibold tracking-widest uppercase my-6 before:flex-1 before:border-b before:border-white/[0.06] before:mr-3.5 after:flex-1 after:border-b after:border-white/[0.06] after:ml-3.5">
                ...
                <form onSubmit={handleAuth} className="flex flex-col gap-0" noValidate>
                  ...
                  {mode === 'signup' && (
                    <div className="mb-3.5 relative">
                      <label htmlFor="displayName" className={`block text-[12px] font-medium mb-1.5 tracking-wider transition-colors ${touched.displayName && errors.displayName ? 'text-red-400' : 'text-slate-300'}`}>Full Name</label>
                      <div className="relative flex items-center">
                        ...
                        <input
                          ...
                          className={`w-full bg-white/[0.03] border rounded-xl py-3 pl-11 pr-3.5 text-white text-sm outline-none transition duration-200 placeholder-slate-500 focus:bg-white/[0.05] focus:ring-4 ${touched.displayName && errors.displayName ? 'border-red-500/50 focus:border-red-500/50 focus:ring-red-500/10' : 'border-white/[0.08] focus:border-white/18 focus:ring-[#e87070]/10'}`}
                  ...
                  {/* Email field */}
                  <div className="mb-3.5 relative">
                    <label htmlFor="email" className={`block text-[12px] font-medium mb-1.5 tracking-wider transition-colors ${touched.email && errors.email ? 'text-red-400' : 'text-slate-300'}`}>Email Address</label>
                    <div className="relative flex items-center">
                      ...
                      <input
                        ...
                        className={`w-full bg-white/[0.03] border rounded-xl py-3 pl-11 pr-3.5 text-white text-sm outline-none transition duration-200 placeholder-slate-500 focus:bg-white/[0.05] focus:ring-4 ${touched.email && errors.email ? 'border-red-500/50 focus:border-red-500/50 focus:ring-red-500/10' : 'border-white/[0.08] focus:border-white/18 focus:ring-[#e87070]/10'}`}
                  ...
                  <div className="mb-3.5 relative">
                    <div className="flex justify-between items-center">
                      <label htmlFor="password" className={`block text-[12px] font-medium mb-1.5 tracking-wider transition-colors ${touched.password && errors.password ? 'text-red-400' : 'text-slate-300'}`}>Password</label>
                      {mode === 'signin' && (
                        <button
                          type="button"
                    ...
                    <div className="relative flex items-center">
                      ...
                      <input
                        ...
                        className={`w-full bg-white/[0.03] border rounded-xl py-3 pl-11 pr-11 text-white text-sm outline-none transition duration-200 placeholder-slate-500 focus:bg-white/[0.05] focus:ring-4 ${touched.password && errors.password ? 'border-red-500/50 focus:border-red-500/50 focus:ring-red-500/10' : 'border-white/[0.08] focus:border-white/18 focus:ring-[#e87070]/10'}`}
                        placeholder="••••••••"
                    ...
                    {mode === 'signup' && password.length > 0 && (
                      <div className="mt-2 flex flex-wrap gap-x-3 gap-y-1">
                        <span className={`flex items-center gap-1.5 text-xs transition-colors duration-200 ${pwDetails.met.length ? 'text-emerald-400' : 'text-slate-500'}`}>
                        ...
                        <span className={`flex items-center gap-1.5 text-xs transition-colors duration-200 ${pwDetails.met.upper ? 'text-emerald-400' : 'text-slate-500'}`}>
                        ...
                        <span className={`flex items-center gap-1.5 text-xs transition-colors duration-200 ${pwDetails.met.number ? 'text-emerald-400' : 'text-slate-500'}`}>
                        ...
                        <span className={`flex items-center gap-1.5 text-xs transition-colors duration-200 ${pwDetails.met.special ? 'text-emerald-400' : 'text-slate-500'}`}>
                    ...
                    {mode === 'signup' && password.length > 0 && (
                      <div className="mt-2 animate-[slide-in_0.3s_ease-out]">
                        ...
                        <div className="flex justify-between items-center text-[11px] mt-1 text-slate-450">
                  ...
                  {mode === 'signup' && (
                    <div className="mb-3.5 relative">
                      <label htmlFor="confirmPassword" className={`block text-[12px] font-medium mb-1.5 tracking-wider transition-colors ${touched.confirmPassword && errors.confirmPassword ? 'text-red-400' : 'text-slate-300'}`}>Confirm Password</label>
                      <div className="relative flex items-center">
                        ...
                        <input
                          ...
                          className={`w-full bg-white/[0.03] border rounded-xl py-3 pl-11 pr-11 text-white text-sm outline-none transition duration-200 placeholder-slate-500 focus:bg-white/[0.05] focus:ring-4 ${touched.confirmPassword && errors.confirmPassword ? 'border-red-500/50 focus:border-red-500/50 focus:ring-red-500/10' : 'border-white/[0.08] focus:border-white/18 focus:ring-[#e87070]/10'}`}
                          placeholder="••••••••"
                  ...
                  {mode === 'signin' && (
                    <div className="flex items-center justify-between mb-4.5 mt-0.5">
                      <label className="flex items-center gap-2 text-[13px] text-slate-400 cursor-pointer select-none transition-colors hover:text-slate-300" htmlFor="rememberMe">
                        <input
                          type="checkbox"
                          id="rememberMe"
                          name="rememberMe"
                    ...
                    <div className={`mb-3.5 relative ${touched.terms && errors.terms ? 'text-red-400' : ''}`}>
                      <div className="my-1 mb-3.5 flex items-start">
                        <label className="flex items-start gap-2.5 cursor-pointer text-[13px] text-white/40 leading-normal select-none" htmlFor="terms">
                          ...
                          />
                          <span>
                            I agree to the <strong className="text-white/70 hover:text-[#e87070] transition-colors">Terms of Service</strong> and <strong className="text-white/70 hover:text-[#e87070] transition-colors">Privacy Policy</strong>.
                          </span>
                        </label>
                      </div>
      ...
      {showForgotModal && (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/75 backdrop-blur-sm" onClick={() => setShowForgotModal(false)}>
          <div className="bg-[#121215] border border-white/[0.08] rounded-2xl p-8 md:p-9 max-w-[420px] w-[90%] text-left shadow-[0_24px_64px_rgba(0,0,0,0.6)] relative" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true" aria-labelledby="modal-title">
            <button 
              type="button" 
                ...
                <div className="mb-4.5 relative">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <input
                      ...
                      className="w-full bg-white/[0.03] border border-white/[0.08] rounded-xl py-3 pl-11 pr-3.5 text-white text-sm outline-none transition duration-200 shadow-[inset_0_2px_4px_rgba(0,0,0,0.2)] focus:border-white/18 focus:bg-white/6"
                      placeholder="you@example.com"
                      required
                    />
                  </div>
