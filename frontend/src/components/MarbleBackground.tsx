...
export const MarbleBackground: React.FC = () => {
  ...
  return (
    <>
      ...
      `}</style>
      <div className="marble-host-wrapper">
        <div className="marble-host-container">
          <div className="marble-bg-image"></div>
          
          {/* Organic SVG Blob */}
          <svg className="marble-blob" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
          ...
          <button className="marble-back-btn" onClick={goBack} type="button">
